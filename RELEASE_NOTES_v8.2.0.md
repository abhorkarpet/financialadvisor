# Smart Retire AI v8.2.0 Release Notes
...
**Usage:**
```bash
./update_version.sh 8.2.0

# Interactive prompts:
# 1. Review changes (git diff)
# 2. Stage and commit
# 3. Create git tag 'v8.2.0'
# 4. Push to remote
```
...
- `RELEASE_NOTES_v8.2.0.md` - This file
...
**Development Period:** v7.5.0 (Jan 12, 2026) → v8.2.0 (Jan 14, 2026)
